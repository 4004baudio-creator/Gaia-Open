# Lane filter (all ingest)

Sort, not gag. Exploration stays open. What changes is the stamp.
Applies to this chat, GO law, edge packets, media claims, inventories, catalogues, models.
...
| Lane | What it is | Stamp |
|---|---|---|
| Grounded | Open speech or files two nodes can pull. Same window, same units, rival allowed. | ANCHORED / PLAUSIBLE — may sit on the map |
| Expansive | Lived note, pattern not yet tied, story, model, “it keeps showing up” | BESIDE / OPEN_FIELD / IMAGINED — still speakable |

The filter answers: *which lane is this packet in?*
It does not answer: *may we talk about it?*
...
- it loses to a higher-rank instrument and is re-stamped.

Weight = reproducibility + rank + failed predictions.
